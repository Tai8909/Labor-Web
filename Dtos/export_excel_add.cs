...
{
    public partial class export_excel_add
    {
        private string num;
        ...
        public string format_num { get => for_num; set => for_num = value; }
        ...
        public string salary_mounth { get => salary; set => salary = value; }
        ...
        public string ins_special_identity { get => ins_sp_id; set => ins_sp_id = value; }
        [CsvHelper.Configuration.Attributes.Name("僅參加「職保」條件")]
        public string condition { get => con; set => con = value; }
        ...
        public string submit_identity { get => sub_id; set => sub_id = value; }
